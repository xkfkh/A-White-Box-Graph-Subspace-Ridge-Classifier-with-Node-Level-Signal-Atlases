"""
L1 Innovation: Graph-Aware Coding Rate (GACR)
...
OUTPUT_PATH = os.path.join(OUT_DIR, "l1_gacr_output.txt")
...
def graph_aware_coding_rate_gradient(Z, L, alpha, eps=0.5):
    """
...
def run_experiment():
    ...
    log("=" * 60)
    log("Experiment: L1 Graph-Aware Coding Rate (GACR)")
    log(f"Config: {cfg}")
    log("=" * 60)
...
if __name__ == '__main__':
    log("L1 Innovation: Graph-Aware Coding Rate (GACR)")
